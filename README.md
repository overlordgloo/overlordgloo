if IY_LOADED and not _G.IY_DEBUG == true then
	error("Gloo's GUI is already running!",0)
	return
end
...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'Gloo's GUI is waiting for the game to load'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
PluginsHint.Text = "Download plugins from the IY Discord (discord.io/overlordpent)"
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		...
		if func then
			func("https://discord.io/overlordpent")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.io/overlordpent)"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- Gloo's GUI Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the Gloo's GUI support server.'}
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	...
	if toClipboard then
		toClipboard('https://discord.com/invite/overlordpent')
		notify('Discord Invite', 'Copied to clipboard!\ndiscord.gg/overlordpent')
	else
		notify('Discord Invite', 'discord.gg/overlordpent')
	end
